...
from controllers.TableHeader import TableHeader
from controllers.HashTable import HashTable
import time
...
class GlobalController:
	...
	def execute(self, string):
		...
		self.log.write("----------TRANSACTION START----------\n")
		self.log.write("TIME: " + str(time.asctime()) + "\n")
		self.log.write("QUERY: " + string + "\n")
		...
		try:
			...
			result.append("ERROR")
		self.log.write("OK\n")
		self.log.write("----------TRANSACTION END----------\n\n")
		self.log.flush()
		return result
...
#s = gc.query("SELECT word FROM k_t_a|article|keywords WHERE article.a_id=fa9b95ea2fbd8575c08ba585b23d4aca ;")
